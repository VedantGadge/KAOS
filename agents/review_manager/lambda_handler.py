...
logger.info("🧠 Compiling Review Manager LangGraph for Lambda...")
review_graph = build_review_graph()
logger.info("✅ Review Manager LangGraph Compiled")

def handler(event, context):
    """
    AWS Lambda Handler for Review Manager Agent.
    ...
    for topic_partition, record_list in records.items():
        for record in record_list:
            ...
            try:
                ...
                review_graph.invoke({"message": message})
                processed_count += 1

...
logger.info("🧠 Compiling Ops Manager LangGraph for Lambda...")
ops_graph = build_ops_graph()
logger.info("✅ Ops Manager LangGraph Compiled")

def handler(event, context):
    """
    AWS Lambda Handler for Ops Manager Agent.
    ...
    for topic_partition, record_list in records.items():
        for record in record_list:
            ...
            try:
                ...
                ops_graph.invoke({"message": message})
                processed_count += 1
